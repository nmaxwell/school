...
\noindent
%$P( \{ X=1 \} ) = \sum_{n=1}^4 P( \{ X=1 \} | \{ N = n\} ) \cdot P(\{ N = n\} ) =   $
...
%Now $E[ \cf{A_k}X ] = \int_{\Om \times \Om^4} \cf{A_k}X \,d(P \times P^4)    $ $= \int_{\Om \times \Om^4} \cf{A_k}(\om') \sum_{k=1}^{N(\om')} \cf{A}(\om_k) \,d(P \times P^4)   $
...
%$ P_{i,j} = P( \{  X_k + \cf{E_k} = i\} | \{ X_k = j \} ) = P( \{  j + \cf{E_k} = i\} | \{ X_k = j \} ) = P( \{  \cf{E_k} = i - j \} | \{ X_k = j \} ) $.
